        ...
        <div class="p-6">
            ...
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 bg-white text-gray-900 p-3 rounded-lg shadow-sm focus:shadow-md transition-shadow focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500" placeholder="Ex: Électronique, Vêtements..." required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs text-gray-600 mt-2">Laissez vide pour créer une catégorie principale, ou sélectionnez une catégorie existante pour créer une sous-catégorie</p>
                </div>
